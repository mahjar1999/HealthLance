...
class OfflineAppoinmentDetails extends StatefulWidget {
  ...
  @override
  State<OfflineAppoinmentDetails> createState() => _OfflineAppoinmentDetailsState();
}
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Container(
              decoration:
                  BoxDecoration(color: kbigContainerColor, borderRadius: const BorderRadius.only(topLeft: Radius.circular(20), topRight: Radius.circular(20))),
              child: Padding(
                padding: const EdgeInsets.all(10.0),
                child: Column(
                  children: [
                    ...
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ImageIcon(const AssetImage("assets/images/ic_hospital.png"), color: kSubTitleColor),
                        const SizedBox(
                          width: 12,
                        ),
                        Column(
