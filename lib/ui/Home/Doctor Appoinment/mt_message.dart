    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            const CircleAvatar(radius: 20, backgroundImage: NetworkImage('https://assets.iqonic.design/old-themeforest-images/prokit/datingApp/Image.3.jpg')),
            8.width,
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Doctor', style: boldTextStyle()),
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              Icon(Icons.send_outlined, size: 24, color: kMainColor).paddingAll(4.0).onTap(
                    () {
